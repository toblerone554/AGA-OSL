...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { cpu: @component.cpu, localizacion: @component.localizacion, ram: @component.ram, referencia: @component.referencia, revisado: @component.revisado, tipo: @component.tipo }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { cpu: @component.cpu, localizacion: @component.localizacion, ram: @component.ram, referencia: @component.referencia, revisado: @component.revisado, tipo: @component.tipo }
    assert_redirected_to component_path(assigns(:component))
  end
